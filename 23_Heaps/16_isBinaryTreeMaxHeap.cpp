...
int main(){
    vector<int> v1 = {20,15,10,8,11,INT_MIN,6};
    Node* root1 = construct(v1);
    if(isCBT(root1) and isMaxHeap(root1)) cout<<"Tree is MaxHeap.";
    else cout<<"Tree is not a MaxHeap!";
    cout<<endl;
    
    vector<int> v2 = {20,15,10,8,11,6};
    Node* root2 = construct(v2);
    if(isCBT(root2) and isMaxHeap(root2)) cout<<"Tree is MaxHeap.";
    else cout<<"Tree is not a MaxHeap!";
}